...
import SlotMachineUnique from "../../../components/ui/SlotWheelUnique"; // Importation de SlotMachine
...
export default function Page({ params }: { params: { id: string } }) {
  ...
  <div className="h-screen flex-col bg-black p-6">
   ...
   <div className="bg-cover bg-center flex bg-cover rounded-xl  h-5/6"   style={{ backgroundImage: `url(${background})` }}>
      ...
      <div className="flex flex-col justify-center items-center h-auto space-y-2  ml-9 w-4/5 border-2">
        <div className="">
        <div>
      {isPageLoading ? (
       <div ></div> // Affiche un loader
      ) : (
        <div className="flex space-x-4 border-8 border-gray-500 p-8 rounded-3xl bg-gray-900 mb-4 mt-6 w-full max-w-5xl mx-auto">
        <SlotMachineUnique
