...
export default function SecondVerticalBagMen() {
  const categories = [
    { name: "All bags", link: "/bags/all" },
    { name: "Handbags", link: "/bags/type/handbag" },
    { name: "Shoulder Bags", link: "/bags/type/shoulderbag" },
  ];
