...
export default function SecondVerticalMenBagsAccessories() {
  const categories = [

    { name: "Bags", link: "/men/bags-accessories/bags" },
    { name: "Belts", link: "/men/bags-accessories/belts" },
    { name: "All", link: "/men/bags-accessories/new-arrivals" },
  ];
